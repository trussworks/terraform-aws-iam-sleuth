...
| slack\_message\_text | The content of the Slack message | `string` | `"https://github.com/transcom/ppp-infra/tree/master/transcom-ppp#rotating-aws-access-keys"` | no |
| slack\_message\_title | The title of the Slack message | `string` | `"Access Key Rotation Instructions"` | no |
| sns\_message | The message that will be sent through the SNS topic | `string` | `"How to doc for '\u003chttps://github.com/transcom/ppp-infra/tree/master/transcom-ppp#rotating-aws-access-keys|key rotation\u003e. TLDR: \n`<pre>cd transcom-ppp\ngit pull \u0026\u0026 rotate-aws-access-key</pre>\n\nOnce key is expired will require team Infra involvement to reset key and MFA" | no |
